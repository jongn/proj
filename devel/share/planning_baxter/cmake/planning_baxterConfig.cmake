...
if("TRUE" STREQUAL "TRUE")
  set(planning_baxter_SOURCE_PREFIX /home/cc/ee106a/fa17/class/ee106a-adj/ros_workspaces/proj/src/planning_baxter)
  set(planning_baxter_DEVEL_PREFIX /home/cc/ee106a/fa17/class/ee106a-adj/ros_workspaces/proj/devel)
  ...
  set(planning_baxter_INSTALL_PREFIX /home/cc/ee106a/fa17/class/ee106a-adj/ros_workspaces/proj/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'planning_baxter' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ee106a-adj <ee106a-adj@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'planning_baxter' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106a/fa17/class/ee106a-adj/ros_workspaces/proj/src/planning_baxter/${idir}'.  Ask the maintainer 'ee106a-adj <ee106a-adj@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cc/ee106a/fa17/class/ee106a-adj/ros_workspaces/proj/devel/lib;/home/cc/ee106a/fa17/class/ee106a-adj/ros_workspaces/proj/devel/lib;/home/cc/ee106a/fa17/class/ee106a-adj/ros_workspaces/lab4/devel/lib;/scratch/shared/baxter_ws/devel/lib;/opt/ros/indigo/lib)
